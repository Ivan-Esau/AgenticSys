"""
Improved pipeline configuration based on modern CI/CD best practices.
Implements 5-stage pipeline with consistent structure across tech stacks.
"""
...
class ImprovedPipelineConfig:
    ...
    def __init__(self, tech_stack: Optional[Dict[str, str]] = None):
        """
        Initialize improved pipeline configuration.
    ...
    def generate_improved_pipeline_yaml(self) -> str:
        """Generate improved 5-stage GitLab CI YAML configuration."""
        yaml_lines = []

        # Header
        yaml_lines.extend([
            f"# Modern 5-Stage CI/CD Pipeline for {self.backend}",
            "# Auto-generated by ImprovedPipelineConfig",
...
if __name__ == "__main__":
    ...
    for tech in tech_stacks:
        config = ImprovedPipelineConfig(tech)
        print(f"\n{'='*60}")
